...
PR Title: conventional commits format, like `feat(owner/repo#123): replace FQDN with unqualified class name in component headers` or `feat(#123)` for local repo issues
